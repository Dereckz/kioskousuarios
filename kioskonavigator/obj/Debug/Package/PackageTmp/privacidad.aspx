<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="privacidad.aspx.cs" Inherits="kioskotem.privacidad" %>
  ...
  <div class="login-box-body "  style =" text-align:justify ;">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <span>De conformidad con lo dispuesto en la Ley Federal de Protección de Datos 
            Personales en Posesión de los Particulares y en su Reglamento, hace de su 
            conocimiento que “TRASNPORTE SOVER” S.A. DE C.V. recabara y protejera sus 
            datos personales. Si usted no manifiesta su oposición para que estos sean 
            transferidos, se entenderá que ha otorgado su consentimiento para ello. 
            Información que será utilizada para proveerle de los servicios de consulta de 
            pagos, concepto del pago y recibos que nos ha solicitado, informarle sobre 
            condiciones y cambios en los mismos y evaluar la calidad del servicio que le 
            prestamos.</span><br />
            <br />
...
<b>Finalidad en el tratamiento de sus datos personales</b><br /><br />
            ...
            <p class="MsoNormal" style="text-align:justify">
                <span>Recopilamos sus datos personales, por lo que solicitamos su consentimiento 
                a través del presente Aviso de Privacidad con el objeto de utilizarlos para los 
                siguientes fines:<p></p>
                </span>
            </p>
            <p class="MsoNormal" style="text-align:justify">
                <span>
    ...
    &nbsp;</p>
            ...
            <p class="MsoNormal" style="text-align:justify">
                <span>1. Para poder proveerle los servicios de consulta de pagos, concepto del 
                pago y recibos que nos ha confiado.<p></p>
                </span>
            </p>
            <p class="MsoNormal" style="text-align:justify">
                <span>2. Identificarlo como cliente y prestarle los servicios contratados con 
                nosotros<p></p>
                </span>
            </p>
            <p class="MsoNormal" style="text-align:justify">
                <span>3. Para contactarlo y enviarle información relevante respecto de temas de 
                nuestros servicios.<p></p>
                </span>
            </p>
<br /><br />
<b>Medios para limitar el uso o divulgación de sus datos personales </b><br />
...
<br /><br />
            ...
            de un correo electrónico a la dirección operadoramx@live.com.mx.
 <br /><br />
...
<br /><br />
            Le informamos que sus datos personales pueden ser transferidos y tratados dentro 
            y fuera del País por personas distintas a TRANSPORTE SOVER, S.A. DE C.V., 
            si nuestros servicios se realizan en un domicilio fuera de la República 
            Mexicana.
<br /><br />
...
• No consiento que mis datos personales sean transferidos en los términos que señala el presente aviso de privacidad.<br /><br />
            ...
            solicitarlo en nuestro departamento de datos personales, en el correo 
            electrónico operadoramx@live.com.mx 
