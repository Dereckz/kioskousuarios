        ...
        protected void dtgnominas_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Delete")
                {
                    ...
                    if (carpetab != "")
                    {
                        Session["ruta"] = "pagosnSOVER/" + carpetab + "/" + sindicato + ".xml";

                        path = Server.MapPath("../pagosnSOVER/") + carpetab + "\\" + sindicato + ".xml";
                        String path2 = "../pagosnNAVIGATOR/" + carpetab + "/" + sindicato + ".xml";
                    }
                    else
                    {
                        Session["ruta"] = "pagosnSOVER/" + sindicato + ".xml";

                        path = Server.MapPath("../pagosnSOVER") + "\\" + sindicato + ".xml";
                        String path2 = "../pagosnSOVER/" + sindicato + ".xml";
                    }
